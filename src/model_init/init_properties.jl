...
function Properties(parameters::Dict{String, Any}, initial_conditions)
    ...
    lambda_p = typeFloat(get(parameters, "lambda_p", 2))
    ...
    return Properties(
        ...
        zeta_b, b_CF_g, b_CFH_g, b_HH_g, c_G_g, c_E_g, c_I_g, a_sg, C, D_H, K_H, sb_other, E_k, r_bar, omega, lambda_p, pi_bar
    )
end
